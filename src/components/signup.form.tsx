  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setSending(true);
        Register({
          ...
          setWarningMessage(["El usuario ya se encuentra registrado"]);
          setSending(false);
        });
    ...
    <div>
      ...
      <SuccessDialog
                    ...
                    />  
        {
          ...
          { showSecondDiv && (
          <div className="relative text-sm leading-[150%] text-black mb-4">
            Ingresa tu contraseña para registrarte en la aplicacion
          </div>
          )}
          { showThirdDiv && (
          <div className="relative text-sm leading-[150%] text-black mb-4">
            Ingresa tus datos adicionales para registrarte en la aplicacion
          </div>
          )}
      ...
      <div className="w-[327px] flex flex-col items-start justify-start gap-4 text-left">
        ...
        <button 
          ...
          <button 
            ...
            onClick={(e) => {
              ...
              if (lastname.length === 0) {
                warnings.push('El apellido es requerido');
              }
          ...
          >
            { sending ? "registrando..." : "Registrame" }
