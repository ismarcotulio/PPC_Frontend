  ...
  return (
    <div className="w-full relative bg-whitesmoke-100 overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[188px] box-border leading-[normal] tracking-[normal] text-left text-base text-color-palette-neutral-50 font-semibold-body-button">
      <div className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[11px] box-border max-w-full">
        <div className="flex-1 bg-color-palette-neutral-00 flex flex-col items-start justify-start max-w-full">
      ...
      <main className="self-stretch bg-color-palette-neutral-00 flex flex-col items-start justify-start max-w-full">
        <section className="self-stretch flex flex-row items-start justify-start py-0 px-6 box-border max-w-full">
          <div className="flex-1 flex flex-row items-start justify-start max-w-full">
            <div className="flex-1 flex flex-col items-start justify-start pt-[26px] px-4 pb-2 box-border relative max-w-full">
        ...
        <section className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-6 box-border gap-2 max-w-full text-left text-lg text-color-palette-neutral-90 font-semibold-body-button">
          <div className="self-stretch flex flex-col items-start justify-center py-2.5 px-6">
            <div className="self-stretch flex flex-col items-center justify-center">
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-4">
                <div className="flex-1 relative leading-[28px] font-semibold inline-block min-w-[149px]">
        ...
        <section className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-6 box-border gap-2 max-w-full text-left text-lg text-color-palette-neutral-90 font-semibold-body-button">
          <div className="self-stretch flex flex-col items-start justify-center py-2.5 px-6">
            <div className="self-stretch flex flex-col items-center justify-center">
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-4">
                <div className="flex-1 relative leading-[28px] font-semibold inline-block min-w-[143px]">
        ...
        <section className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-6 box-border max-w-full text-left text-lg text-color-palette-neutral-90 font-semibold-body-button">
          <div className="flex-1 flex flex-col items-start justify-start max-w-full">
            <div className="self-stretch flex flex-row flex-wrap items-center justify-center py-2.5 px-6 gap-3">
              <div className="flex-1 flex flex-row items-center justify-start gap-3 min-w-[187px]">
                ...
                <div className="flex-1 flex flex-col items-start justify-start">
                  <div className="self-stretch overflow-hidden flex flex-row items-start justify-start">
                    <div className="relative leading-[28px] font-semibold inline-block min-w-[95px]">
                      Rotarac Sur
                    </div>
                  </div>
                  <div className="self-stretch relative text-sm tracking-[0.04em] leading-[24px] text-color-palette-neutral-60">
                    Organizacion de la semana
                  </div>
                </div>
              </div>
              <div className="rounded-xl flex flex-row items-center justify-center p-0.5">
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/iconarrowrightdefault-2.svg"
                />
              </div>
            </div>
          </div>
        </section>
        <section className="flex flex-row items-start justify-start max-w-full text-left text-base text-color-palette-neutral-90 font-semibold-body-button">
          <div className="h-[215px] w-[375px] hidden max-w-full" />
          <div className="w-[375px] overflow-x-auto shrink-0 flex flex-row items-start justify-start py-[12.5px] pl-5 pr-0 box-border max-w-full z-[1]">
            <div className="w-[696px] shrink-0 flex flex-row items-start justify-start max-w-[197%]">
              <div className="w-[375px] overflow-x-auto shrink-0 flex flex-row items-start justify-start py-0 pl-0 pr-5 box-border max-w-full">
                <div className="w-[168px] shrink-0 flex flex-row items-start justify-start p-1 box-border">
                  <div className="flex-1 flex flex-row items-start justify-start">
                    <div className="flex-1 flex flex-col items-start justify-start gap-3">
                        ...
                        <div className="flex-1 flex flex-row items-start justify-start">
                          <div className="h-[198px] flex-1 relative">
                            <img
                              ...
                              loading="lazy"
                              alt=""
                              src="/iconimagedefault-13.svg"
                            />
                            <img
                              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover z-[1]"
                              alt=""
                              src="/placeholder-13@2x.png"
                            />
                          </div>
                        </div>
                      </div>
                      <div className="self-stretch flex flex-col items-start justify-start">
                        <div className="self-stretch flex flex-col items-start justify-start gap-1">
                          <div className="self-stretch flex flex-row items-start justify-start">
                            <div className="flex-1 relative tracking-[0.02em] leading-[26px]">
                              RTS E Interpaces 2024
                            </div>
                          </div>
                          <div className="flex flex-row items-start justify-start py-0 pl-0 pr-[23px] gap-1 text-color-palette-neutral-50">
                            ...
                            <div className="flex flex-row items-start justify-start text-color-palette-neutral-90">
                              <div className="relative tracking-[0.02em] leading-[26px] font-semibold">
                                Participantes: 202
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="flex-1 flex flex-col items-start justify-start gap-3">
                        ...
                        <div className="flex-1 flex flex-row items-start justify-start">
                          <div className="h-[198px] flex-1 relative">
                            <img
                              ...
                              loading="lazy"
                              alt=""
                              src="/iconimagedefault-14.svg"
                            />
                            <img
                              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover z-[1]"
                              alt=""
                              src="/placeholder-14@2x.png"
                            />
                          </div>
                        </div>
                      </div>
                      <div className="self-stretch flex flex-col items-start justify-start">
                        <div className="self-stretch flex flex-col items-start justify-start gap-1">
                          <div className="self-stretch flex flex-row items-start justify-start">
                            <div className="flex-1 relative tracking-[0.02em] leading-[26px]">
                              Campaña reforestacion Junio 2024
                            </div>
                          </div>
                          <div className="flex flex-row items-start justify-start py-0 pl-0 pr-[23px] gap-1 text-color-palette-neutral-50">
                            <div className="self-stretch hidden flex-row items-start justify-start">
                    ...
                    <div className="flex-1 flex flex-col items-start justify-start gap-3">
                        ...
                        <div className="flex-1 flex flex-row items-start justify-start">
                          <div className="h-[198px] flex-1 relative">
                            <img
                              ...
                              loading="lazy"
                              alt=""
                              src="/iconimagedefault-15.svg"
                            />
                            <img
                              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover z-[1]"
                              alt=""
                              src="/placeholder-15@2x.png"
                            />
                          </div>
                        </div>
                      </div>
                      <div className="self-stretch flex flex-col items-start justify-start">
                        <div className="self-stretch flex flex-col items-start justify-start gap-1">
                          <div className="self-stretch flex flex-row items-start justify-start">
                            <div className="flex-1 relative tracking-[0.02em] leading-[26px]">
                              Lacoste Stretch Cotton Piqué Polo
                            </div>
                          </div>
                          <div className="self-stretch h-[26px] flex flex-row items-start justify-start py-0 pl-0 pr-[81px] box-border gap-[3px] text-color-palette-neutral-60">
                            <div className="flex-1 flex flex-row items-start justify-start">
                              <div className="flex-1 relative [text-decoration:line-through] tracking-[0.02em] leading-[26px] whitespace-nowrap">
                                $199
                              </div>
                            </div>
                        ...
                        <div className="flex-1 flex flex-row items-start justify-start">
                          <div className="h-[198px] flex-1 relative">
                            <img
                              ...
                              loading="lazy"
                              alt=""
                              src="/iconimagedefault-16.svg"
                            />
                            <img
                              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover z-[1]"
                              alt=""
                              src="/placeholder-16@2x.png"
                            />
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-1">
                          <div className="self-stretch flex-1 flex flex-row items-start justify-start">
                            <div className="self-stretch flex-1 relative tracking-[0.02em] leading-[26px]">
                              Lacoste Stretch Polo
                            </div>
                          </div>
                          <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-1 text-color-palette-neutral-50">
                            <div className="self-stretch hidden flex-row items-start justify-start">
                              <div className="self-stretch relative [text-decoration:line-through] tracking-[0.02em] leading-[26px] whitespace-nowrap">
                                $000
                              </div>
                            </div>
                            <div className="self-stretch w-[38px] flex flex-row items-start justify-start text-color-palette-neutral-90">
                              <div className="self-stretch flex-1 relative tracking-[0.02em] leading-[26px] font-semibold whitespace-nowrap">
                                $119
                              </div>
                            </div>
                            ...
                            <div className="h-40 flex-1 relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%]">
                                <img
                                  className="absolute top-[calc(50%_-_12px)] left-[calc(50%_-_12px)] w-6 h-6 overflow-hidden"
                                  alt=""
                                  src="/iconimagedefault-17.svg"
                                />
                                <img
                                  className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
                                  alt=""
                                  src="/placeholder-17@2x.png"
                                />
                              </div>
                            </div>
                          </div>
      ...
      <div className="flex flex-row items-start justify-start py-0 pl-[3px] pr-0 box-border max-w-full text-center text-xs">
        <div className="bg-color-palette-neutral-00 flex flex-row items-start justify-start pt-1 pb-[38px] pl-0 pr-[3px] box-border gap-1 max-w-full">
          <div className="w-[372px] overflow-x-auto shrink-0 flex flex-row items-start justify-start max-w-full">
